...
UClass * GetClassFromString(const FString & ClassName) {
	...
	UClass * LocalClass = ((!FPackageName::IsShortPackageName(ClassName)) ?
		...
		FindFirstObject<UClass>(*ClassName, EFindFirstObjectOptions::None, ELogVerbosity::Warning, TEXT("AdvancedSaveGameSubsystem::GetClassFromString")));
...
void UAdvancedSaveGameSubsystem::Initialize(FSubsystemCollectionBase & Collection) {
	...
	if (GEngine) {
		GEngine->AddOnScreenDebugMessage(-1, 10.0f, FColor::Red, FString(TEXT("UAdvancedSaveGameSubsystem.Initialize: ")) + FString::FromInt((int32)SubSystemIndex));
	}
}
...
void UAdvancedSaveGameSubsystem::Deinitialize() {
	...
	// DEBUG ONLY - Print out the total number of bytes that require saving
	if (GEngine) {
		GEngine->AddOnScreenDebugMessage(-1, 10.0f, FColor::Red, FString(TEXT("UAdvancedSaveGameSubsystem.Deinitialize: ")) + FString::FromInt((int32)SubSystemIndex));
	}
}
...
// 
void UAdvancedSaveGameSubsystem::SetCurrentGameID(const FString & NewGameID) {
	CurrentSaveGameID = NewGameID;
}


// 
void UAdvancedSaveGameSubsystem::SetLevelSavingTypes(const LevelSavingTypesEnum NewLevelSavingTypes) {
	LevelSavingTypes = NewLevelSavingTypes;
}


// 
void UAdvancedSaveGameSubsystem::SetCharacterDataCompression(const CompressionOptionsEnum NewCharacterDataCompression) {
	CharacterDataCompression = NewCharacterDataCompression;
}


// 
void UAdvancedSaveGameSubsystem::SetLevelDataCompression(const CompressionOptionsEnum NewLevelDataCompression) {
	LevelDataCompression = NewLevelDataCompression;
}


// 
void UAdvancedSaveGameSubsystem::SetStoryDataCompression(const CompressionOptionsEnum NewStoryDataCompression) {
	StoryDataCompression = NewStoryDataCompression;
}


// 
void UAdvancedSaveGameSubsystem::SetStoredDataCompression(const CompressionOptionsEnum NewStoredDataCompression) {
...
// 
void UAdvancedSaveGameSubsystem::StoreCharacters() {
...
// 
void UAdvancedSaveGameSubsystem::StoreCharacter(const uint8 & CharacterIndex) {
...
// 
void UAdvancedSaveGameSubsystem::SaveCharacters() {
...
// 
void UAdvancedSaveGameSubsystem::SaveCharacter(const uint8 & CharacterIndex) {
...
// 
void UAdvancedSaveGameSubsystem::LoadCharacters() {
...
// 
void UAdvancedSaveGameSubsystem::LoadCharacter(const uint8 & CharacterIndex) {
...
void UAdvancedSaveGameSubsystem::SaveLevelHelperFunction(const ULevel * CurrentLevelPointer, TMap<FName, TArray<uint8>> & CurrentLevelMap) {
...
// 
template<bool IsPersistentLevel>
void UAdvancedSaveGameSubsystem::StoreLevelHelperFunction(const ULevel * CurrentLevelPointer) {
...
// 
void UAdvancedSaveGameSubsystem::StoreLevels() {
...
// 
void UAdvancedSaveGameSubsystem::StoreLevel(const FName & LevelName) {
...
// 
void UAdvancedSaveGameSubsystem::SaveLevels() {
...
// 
void UAdvancedSaveGameSubsystem::SaveLevel(const FName & LevelName) {
...
// 
template<bool IsPersistentLevel>
void UAdvancedSaveGameSubsystem::LoadLevelHelperFunction(const ULevel * CurrentLevelPointer) {
...
// 
void UAdvancedSaveGameSubsystem::LoadLevels() {
...
// 
void UAdvancedSaveGameSubsystem::LoadLevel(const FName & LevelName) {
...
// 
void UAdvancedSaveGameSubsystem::SaveGame() {
	this->SaveCharacters();
	this->SaveLevels();
...
// 
void UAdvancedSaveGameSubsystem::AutoSaveGame() {
...
// 
void UAdvancedSaveGameSubsystem::LoadGame() {
	this->LoadLevels();
	this->LoadCharacters();
}
